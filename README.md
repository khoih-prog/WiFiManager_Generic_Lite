...
3. Install [**WiFiManager_Generic_Lite** library](https://platformio.org/lib/show/xxxxx/WiFiManager_Generic_Lite) by using [Library Manager](https://platformio.org/lib/show/xxxxx/WiFiManager_Generic_Lite/installation). Search for **WiFiManager_Generic_Lite** in [Platform.io Author's Libraries](https://platformio.org/lib/search?query=author:%22Khoi%20Hoang%22)
