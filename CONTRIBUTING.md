## Contributing to WiFiManager_Generic_Lite
...
```
xy@xy-Inspiron-3593:~$ cd Arduino/xy/WiFiManager_Generic_Lite_GitHub/
xy@xy-Inspiron-3593:~/Arduino/xy/WiFiManager_Generic_Lite_GitHub$
```

2. Issue astyle command

```
xy@xy-Inspiron-3593:~/Arduino/xy/WiFiManager_Generic_Lite_GitHub$ bash utils/restyle.sh
```
