...
#define RETRY_TIMES_CONNECT_WIFI      3
      ...
      if (iHostname[0] == 0)
      {
        ...
        String _hostname = "NRF52-WIFI-" + randomNum;
...
#define  CONFIG_PORTAL_FILENAME_BACKUP    ("/wm_cp.bak")
    ...
    void saveDynamicData()
    {
      ...
      WG_LOGERROR1(F("CrWCSum=0x"), String(checkSum, HEX));
    ...
    bool loadConfigData()
    {
      ...
      file.seek(0);
      file.read((char *) &WIFI_GENERIC_config, sizeof(WIFI_GENERIC_config));
    ...
    void saveConfigData()
    {
      ...
      WG_LOGERROR1(F("WCSum=0x"), String(calChecksum, HEX));
    ...
    bool getConfigData()
    {
      ...
      if (!InternalFS.begin())
      {
        WG_LOGERROR(F("InternalFS failed"));
        return false;
      }
...
#endif    //WiFiManager_Generic_Lite_nRF52_h
