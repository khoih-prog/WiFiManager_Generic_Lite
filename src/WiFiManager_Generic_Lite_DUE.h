...
const char WIFI_GENERIC_HTML_HEAD_START[] /*PROGMEM*/ = "<!DOCTYPE html><html><head><title>SAM_DUE_WM_Lite</title>";
      ...
      {        
        ...
        if (key == "" && value == "")
        {
          ...
          if ( RFC952_hostname[0] != 0 )
          {
            ...
            result.replace("DUE_WM_Lite", RFC952_hostname);
          }
